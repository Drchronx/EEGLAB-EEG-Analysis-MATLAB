...
% --- 读取条件 2 ---
for i=1:n_subj
    subj_fn = group2_files(i).name; % 确保文件名排序一致
...
target_elec_name = 'Pz'; % 在这里输入你想要的电极名字，比如 'Pz', 'Cz', 'Fz'
...
%% 6. 关键修改：全脑统计地形图 (Repeated Measures)
